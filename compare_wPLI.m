...
all_values_lowbeta = vertcat(vectors_lowbeta{:});  % or: all_values = [vectors{:}](:);

% Step 2: Count occurrences
[unique_vals_lowbeta, ~, idx] = unique(all_values_lowbeta);
counts = accumarray(idx, 1);

% Step 3: Find the most frequent value(s)
[max_count, max_idx] = max(counts);
...
all_values_highbeta = vertcat(vectors_highbeta{:});  % or: all_values = [vectors{:}](:);
...
all_values_gamma = vertcat(vectors_gamma{:});  % or: all_values = [vectors{:}](:);
...
wPLI_sub001_count_delta = {mean(wPLI_epoch{7,1},3), mean(wPLI_epoch{9,1},3)};
wPLI_sub001_count_delta_avg = zeros(size(wPLI_epoch{7,1},1));
for i = 1:size(wPLI_epoch{7,1},1)
    for j = 1:size(wPLI_epoch{7,1},1)
        wPLI_sub001_count_delta_avg(i,j) = mean([wPLI_sub001_count_delta{1}(i,j) wPLI_sub001_count_delta{2}(i,j)]);
    end
end

wPLI_sub001_memory_delta = {mean(wPLI_epoch{8,1},3), mean(wPLI_epoch{10,1},3)};
wPLI_sub001_memory_delta_avg = zeros(size(wPLI_epoch{8,1},1));
for i = 1:size(wPLI_epoch{8,1},1)
    for j = 1:size(wPLI_epoch{8,1},1)
        wPLI_sub001_memory_delta_avg(i,j) = mean([wPLI_sub001_memory_delta{1}(i,j) wPLI_sub001_memory_delta{2}(i,j)]);
    end
end

wPLI_sub001_NS_delta_avg = mean(wPLI_epoch{11,1},3);

min_val = min(min([wPLI_sub001_count_delta_avg(:); wPLI_sub001_memory_delta_avg(:); wPLI_sub001_NS_delta_avg(:)]));
max_val = max(max([wPLI_sub001_count_delta_avg(:); wPLI_sub001_memory_delta_avg(:); wPLI_sub001_NS_delta_avg(:)]));

figure; 
subplot(3,5,1)
imagesc(wPLI_sub001_count_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;

% Draw lines
for i = 1:length(idx)
    % Horizontal
    line([0.5, num_reg+0.5], [idx(i)+0.5, idx(i)+0.5], 'Color', 'k', 'LineWidth', 2);
    % Vertical
    line([idx(i)+0.5, idx(i)+0.5], [0.5, num_reg+0.5], 'Color', 'k', 'LineWidth', 2);
end

% Add row labels just to the left of the matrix
for i = 1:length(idx)
    text(-3, idx(i), labels{i}, ...
        'HorizontalAlignment', 'right', 'VerticalAlignment', 'middle', ...
        'FontSize', 9, 'FontWeight', 'bold');
end

% Add column labels above the matrix, rotated
for i = 1:length(idx)
    text(idx(i), -3, labels{i}, ...
        'HorizontalAlignment', 'right', 'VerticalAlignment', 'top', ...
        'FontSize', 9, 'FontWeight', 'bold', 'Rotation', 90);
end

% Label at index 100 (without a line)
text(-3, 100, 'DMN', ...
    'HorizontalAlignment', 'right', 'VerticalAlignment', 'middle', ...
    'FontSize', 9, 'FontWeight', 'bold');
...
% Tighten axis limits to matrix size
xlim([0.5, num_reg+0.5]);
ylim([0.5, num_reg+0.5]);

set(gca, 'YDir', 'normal'); % optional, if needed
set(gca, 'XTick', [], 'YTick', []);
hold on;

subplot(3,5,6)
imagesc(wPLI_sub001_memory_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,11)
imagesc(wPLI_sub001_NS_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub003_count_delta_avg = mean(wPLI_epoch{1,1},3);

wPLI_sub003_memory_delta_avg = mean(wPLI_epoch{2,1},3);

wPLI_sub003_NS_delta = {mean(wPLI_epoch{3,1},3), mean(wPLI_epoch{4,1},3), mean(wPLI_epoch{5,1},3), mean(wPLI_epoch{6,1},3)};
wPLI_sub003_NS_delta_avg = zeros(size(wPLI_epoch{3,1},1));
for i = 1:size(wPLI_epoch{3,1},1)
    for j = 1:size(wPLI_epoch{3,1},1)
        wPLI_sub003_NS_delta_avg(i,j) = mean([wPLI_sub003_NS_delta{1}(i,j) wPLI_sub003_NS_delta{2}(i,j) wPLI_sub003_NS_delta{3}(i,j) wPLI_sub003_NS_delta{4}(i,j)]);
    end
end

min_val = min(min([wPLI_sub003_count_delta_avg; wPLI_sub003_memory_delta_avg; wPLI_sub003_NS_delta_avg]));
max_val = max(max([wPLI_sub003_count_delta_avg; wPLI_sub003_memory_delta_avg; wPLI_sub003_NS_delta_avg]));

subplot(3,5,2)
imagesc(wPLI_sub003_count_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,7)
imagesc(wPLI_sub003_memory_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,12)
imagesc(wPLI_sub003_NS_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub010_count_delta = {mean(wPLI_epoch{12,1},3), mean(wPLI_epoch{14,1},3)};
wPLI_sub010_count_delta_avg = zeros(size(wPLI_epoch{12,1},1));
for i = 1:size(wPLI_epoch{12,1},1)
    for j = 1:size(wPLI_epoch{12,1},1)
        wPLI_sub010_count_delta_avg(i,j) = mean([wPLI_sub010_count_delta{1}(i,j) wPLI_sub010_count_delta{2}(i,j)]);
    end
end

wPLI_sub010_memory_delta = {mean(wPLI_epoch{13,1},3), mean(wPLI_epoch{15,1},3)};
wPLI_sub010_memory_delta_avg = zeros(size(wPLI_epoch{13,1},1));
for i = 1:size(wPLI_epoch{13,1},1)
    for j = 1:size(wPLI_epoch{13,1},1)
        wPLI_sub010_memory_delta_avg(i,j) = mean([wPLI_sub010_memory_delta{1}(i,j) wPLI_sub010_memory_delta{2}(i,j)]);
    end
end

wPLI_sub010_NS_delta = {mean(wPLI_epoch{17,1},3), mean(wPLI_epoch{18,1},3), mean(wPLI_epoch{19,1},3)};
wPLI_sub010_NS_delta_avg = zeros(size(wPLI_epoch{17,1},1));
for i = 1:size(wPLI_epoch{17,1},1)
    for j = 1:size(wPLI_epoch{17,1},1)
        wPLI_sub010_NS_delta_avg(i,j) = mean([wPLI_sub010_NS_delta{1}(i,j) wPLI_sub010_NS_delta{2}(i,j) wPLI_sub010_NS_delta{3}(i,j)]);
    end
end

min_val = min(min([wPLI_sub010_count_delta_avg(:); wPLI_sub010_memory_delta_avg(:); wPLI_sub010_NS_delta_avg(:)]));
max_val = max(max([wPLI_sub010_count_delta_avg(:); wPLI_sub010_memory_delta_avg(:); wPLI_sub010_NS_delta_avg(:)]));

subplot(3,5,3)
imagesc(wPLI_sub010_count_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,8)
imagesc(wPLI_sub010_memory_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,13)
imagesc(wPLI_sub010_NS_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub029_count_delta = {mean(wPLI_epoch{20,1},3), mean(wPLI_epoch{22,1},3)};
wPLI_sub029_count_delta_avg = zeros(size(wPLI_epoch{20,1},1));
for i = 1:size(wPLI_epoch{20,1},1)
    for j = 1:size(wPLI_epoch{20,1},1)
        wPLI_sub029_count_delta_avg(i,j) = mean([wPLI_sub029_count_delta{1}(i,j) wPLI_sub029_count_delta{2}(i,j)]);
    end
end

wPLI_sub029_memory_delta = {mean(wPLI_epoch{21,1},3), mean(wPLI_epoch{23,1},3)};
wPLI_sub029_memory_delta_avg = zeros(size(wPLI_epoch{21,1},1));
for i = 1:size(wPLI_epoch{21,1},1)
    for j = 1:size(wPLI_epoch{21,1},1)
        wPLI_sub029_memory_delta_avg(i,j) = mean([wPLI_sub029_memory_delta{1}(i,j) wPLI_sub029_memory_delta{2}(i,j)]);
    end
end

wPLI_sub029_NS_delta = {mean(wPLI_epoch{24,1},3), mean(wPLI_epoch{25,1},3)};
wPLI_sub029_NS_delta_avg = zeros(size(wPLI_epoch{24,1},1));
for i = 1:size(wPLI_epoch{24,1},1)
    for j = 1:size(wPLI_epoch{24,1},1)
        wPLI_sub029_NS_delta_avg(i,j) = mean([wPLI_sub029_NS_delta{1}(i,j) wPLI_sub029_NS_delta{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub029_count_delta_avg(:); wPLI_sub029_memory_delta_avg(:); wPLI_sub029_NS_delta_avg(:)]));
max_val = max(max([wPLI_sub029_count_delta_avg(:); wPLI_sub029_memory_delta_avg(:); wPLI_sub029_NS_delta_avg(:)]));

subplot(3,5,4)
imagesc(wPLI_sub029_count_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,9)
imagesc(wPLI_sub029_memory_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,14)
imagesc(wPLI_sub029_NS_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub034_count_delta = {mean(wPLI_epoch{26,1},3), mean(wPLI_epoch{28,1},3)};
wPLI_sub034_count_delta_avg = zeros(size(wPLI_epoch{7,1},1));
for i = 1:size(wPLI_epoch{26,1},1)
    for j = 1:size(wPLI_epoch{26,1},1)
        wPLI_sub034_count_delta_avg(i,j) = mean([wPLI_sub034_count_delta{1}(i,j) wPLI_sub034_count_delta{2}(i,j)]);
    end
end

wPLI_sub034_memory_delta = {mean(wPLI_epoch{27,1},3), mean(wPLI_epoch{29,1},3)};
wPLI_sub034_memory_delta_avg = zeros(size(wPLI_epoch{8,1},1));
for i = 1:size(wPLI_epoch{27,1},1)
    for j = 1:size(wPLI_epoch{27,1},1)
        wPLI_sub034_memory_delta_avg(i,j) = mean([wPLI_sub034_memory_delta{1}(i,j) wPLI_sub034_memory_delta{2}(i,j)]);
    end
end

wPLI_sub034_NS_delta = {mean(wPLI_epoch{30,1},3), mean(wPLI_epoch{31,1},3)};
wPLI_sub034_NS_delta_avg = zeros(size(wPLI_epoch{30,1},1));
for i = 1:size(wPLI_epoch{30,1},1)
    for j = 1:size(wPLI_epoch{30,1},1)
        wPLI_sub034_NS_delta_avg(i,j) = mean([wPLI_sub034_NS_delta{1}(i,j) wPLI_sub034_NS_delta{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub034_count_delta_avg(:); wPLI_sub034_memory_delta_avg(:); wPLI_sub034_NS_delta_avg(:)]));
max_val = max(max([wPLI_sub034_count_delta_avg(:); wPLI_sub034_memory_delta_avg(:); wPLI_sub034_NS_delta_avg(:)]));

subplot(3,5,5)
imagesc(wPLI_sub034_count_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,10)
imagesc(wPLI_sub034_memory_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,15)
imagesc(wPLI_sub034_NS_delta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub001_count_theta = {mean(wPLI_epoch{7,2},3), mean(wPLI_epoch{9,2},3)};
wPLI_sub001_count_theta_avg = zeros(size(wPLI_epoch{7,2},1));
for i = 1:size(wPLI_epoch{7,2},1)
    for j = 1:size(wPLI_epoch{7,2},1)
        wPLI_sub001_count_theta_avg(i,j) = mean([wPLI_sub001_count_theta{1}(i,j) wPLI_sub001_count_theta{2}(i,j)]);
    end
end

wPLI_sub001_memory_theta = {mean(wPLI_epoch{8,2},3), mean(wPLI_epoch{10,2},3)};
wPLI_sub001_memory_theta_avg = zeros(size(wPLI_epoch{8,2},1));
for i = 1:size(wPLI_epoch{8,2},1)
    for j = 1:size(wPLI_epoch{8,2},1)
        wPLI_sub001_memory_theta_avg(i,j) = mean([wPLI_sub001_memory_theta{1}(i,j) wPLI_sub001_memory_theta{2}(i,j)]);
    end
end

wPLI_sub001_NS_theta_avg = mean(wPLI_epoch{11,2},3);

min_val = min(min([wPLI_sub001_count_theta_avg(:); wPLI_sub001_memory_theta_avg(:); wPLI_sub001_NS_theta_avg(:)]));
max_val = max(max([wPLI_sub001_count_theta_avg(:); wPLI_sub001_memory_theta_avg(:); wPLI_sub001_NS_theta_avg(:)]));

figure; 
subplot(3,5,1)
imagesc(wPLI_sub001_count_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,6)
imagesc(wPLI_sub001_memory_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,11)
imagesc(wPLI_sub001_NS_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub003_count_theta_avg = mean(wPLI_epoch{1,2},3);

wPLI_sub003_memory_theta_avg = mean(wPLI_epoch{2,2},3);

wPLI_sub003_NS_theta = {mean(wPLI_epoch{3,2},3), mean(wPLI_epoch{4,2},3), mean(wPLI_epoch{5,2},3), mean(wPLI_epoch{6,2},3)};
wPLI_sub003_NS_theta_avg = zeros(size(wPLI_epoch{3,2},1));
for i = 1:size(wPLI_epoch{3,2},1)
    for j = 1:size(wPLI_epoch{3,2},1)
        wPLI_sub003_NS_theta_avg(i,j) = mean([wPLI_sub003_NS_theta{1}(i,j) wPLI_sub003_NS_theta{2}(i,j) wPLI_sub003_NS_theta{3}(i,j) wPLI_sub003_NS_theta{4}(i,j)]);
    end
end

min_val = min(min([wPLI_sub003_count_theta_avg; wPLI_sub003_memory_theta_avg; wPLI_sub003_NS_theta_avg]));
max_val = max(max([wPLI_sub003_count_theta_avg; wPLI_sub003_memory_theta_avg; wPLI_sub003_NS_theta_avg]));

subplot(3,5,2)
imagesc(wPLI_sub003_count_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,7)
imagesc(wPLI_sub003_memory_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,12)
imagesc(wPLI_sub003_NS_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub010_count_theta = {mean(wPLI_epoch{12,2},3), mean(wPLI_epoch{14,2},3)};
wPLI_sub010_count_theta_avg = zeros(size(wPLI_epoch{12,2},1));
for i = 1:size(wPLI_epoch{12,2},1)
    for j = 1:size(wPLI_epoch{12,2},1)
        wPLI_sub010_count_theta_avg(i,j) = mean([wPLI_sub010_count_theta{1}(i,j) wPLI_sub010_count_theta{2}(i,j)]);
    end
end

wPLI_sub010_memory_theta = {mean(wPLI_epoch{13,2},3), mean(wPLI_epoch{15,2},3)};
wPLI_sub010_memory_theta_avg = zeros(size(wPLI_epoch{13,2},1));
for i = 1:size(wPLI_epoch{13,2},1)
    for j = 1:size(wPLI_epoch{13,2},1)
        wPLI_sub010_memory_theta_avg(i,j) = mean([wPLI_sub010_memory_theta{1}(i,j) wPLI_sub010_memory_theta{2}(i,j)]);
    end
end

wPLI_sub010_NS_theta = {mean(wPLI_epoch{17,2},3), mean(wPLI_epoch{18,2},3), mean(wPLI_epoch{19,2},3)};
wPLI_sub010_NS_theta_avg = zeros(size(wPLI_epoch{17,2},1));
for i = 1:size(wPLI_epoch{17,2},1)
    for j = 1:size(wPLI_epoch{17,2},1)
        wPLI_sub010_NS_theta_avg(i,j) = mean([wPLI_sub010_NS_theta{1}(i,j) wPLI_sub010_NS_theta{2}(i,j) wPLI_sub010_NS_theta{3}(i,j)]);
    end
end

min_val = min(min([wPLI_sub010_count_theta_avg(:); wPLI_sub010_memory_theta_avg(:); wPLI_sub010_NS_theta_avg(:)]));
max_val = max(max([wPLI_sub010_count_theta_avg(:); wPLI_sub010_memory_theta_avg(:); wPLI_sub010_NS_theta_avg(:)]));

subplot(3,5,3)
imagesc(wPLI_sub010_count_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,8)
imagesc(wPLI_sub010_memory_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,13)
imagesc(wPLI_sub010_NS_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub029_count_theta = {mean(wPLI_epoch{20,2},3), mean(wPLI_epoch{22,2},3)};
wPLI_sub029_count_theta_avg = zeros(size(wPLI_epoch{20,2},1));
for i = 1:size(wPLI_epoch{20,2},1)
    for j = 1:size(wPLI_epoch{20,2},1)
        wPLI_sub029_count_theta_avg(i,j) = mean([wPLI_sub029_count_theta{1}(i,j) wPLI_sub029_count_theta{2}(i,j)]);
    end
end

wPLI_sub029_memory_theta = {mean(wPLI_epoch{21,2},3), mean(wPLI_epoch{23,2},3)};
wPLI_sub029_memory_theta_avg = zeros(size(wPLI_epoch{21,2},1));
for i = 1:size(wPLI_epoch{21,2},1)
    for j = 1:size(wPLI_epoch{21,2},1)
        wPLI_sub029_memory_theta_avg(i,j) = mean([wPLI_sub029_memory_theta{1}(i,j) wPLI_sub029_memory_theta{2}(i,j)]);
    end
end

wPLI_sub029_NS_theta = {mean(wPLI_epoch{24,2},3), mean(wPLI_epoch{25,2},3)};
wPLI_sub029_NS_theta_avg = zeros(size(wPLI_epoch{24,2},1));
for i = 1:size(wPLI_epoch{24,2},1)
    for j = 1:size(wPLI_epoch{24,2},1)
        wPLI_sub029_NS_theta_avg(i,j) = mean([wPLI_sub029_NS_theta{1}(i,j) wPLI_sub029_NS_theta{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub029_count_theta_avg(:); wPLI_sub029_memory_theta_avg(:); wPLI_sub029_NS_theta_avg(:)]));
max_val = max(max([wPLI_sub029_count_theta_avg(:); wPLI_sub029_memory_theta_avg(:); wPLI_sub029_NS_theta_avg(:)]));

subplot(3,5,4)
imagesc(wPLI_sub029_count_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,9)
imagesc(wPLI_sub029_memory_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,14)
imagesc(wPLI_sub029_NS_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub034_count_theta = {mean(wPLI_epoch{26,2},3), mean(wPLI_epoch{28,2},3)};
wPLI_sub034_count_theta_avg = zeros(size(wPLI_epoch{7,2},1));
for i = 1:size(wPLI_epoch{26,2},1)
    for j = 1:size(wPLI_epoch{26,2},1)
        wPLI_sub034_count_theta_avg(i,j) = mean([wPLI_sub034_count_theta{1}(i,j) wPLI_sub034_count_theta{2}(i,j)]);
    end
end

wPLI_sub034_memory_theta = {mean(wPLI_epoch{27,2},3), mean(wPLI_epoch{29,2},3)};
wPLI_sub034_memory_theta_avg = zeros(size(wPLI_epoch{8,2},1));
for i = 1:size(wPLI_epoch{27,2},1)
    for j = 1:size(wPLI_epoch{27,2},1)
        wPLI_sub034_memory_theta_avg(i,j) = mean([wPLI_sub034_memory_theta{1}(i,j) wPLI_sub034_memory_theta{2}(i,j)]);
    end
end

wPLI_sub034_NS_theta = {mean(wPLI_epoch{30,2},3), mean(wPLI_epoch{31,2},3)};
wPLI_sub034_NS_theta_avg = zeros(size(wPLI_epoch{30,2},1));
for i = 1:size(wPLI_epoch{30,2},1)
    for j = 1:size(wPLI_epoch{30,2},1)
        wPLI_sub034_NS_theta_avg(i,j) = mean([wPLI_sub034_NS_theta{1}(i,j) wPLI_sub034_NS_theta{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub034_count_theta_avg(:); wPLI_sub034_memory_theta_avg(:); wPLI_sub034_NS_theta_avg(:)]));
max_val = max(max([wPLI_sub034_count_theta_avg(:); wPLI_sub034_memory_theta_avg(:); wPLI_sub034_NS_theta_avg(:)]));

subplot(3,5,5)
imagesc(wPLI_sub034_count_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,10)
imagesc(wPLI_sub034_memory_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,15)
imagesc(wPLI_sub034_NS_theta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub001_count_alpha = {mean(wPLI_epoch{7,3},3), mean(wPLI_epoch{9,3},3)};
wPLI_sub001_count_alpha_avg = zeros(num_reg);
for i = 1:num_reg
    for j = 1:num_reg
        wPLI_sub001_count_alpha_avg(i,j) = mean([wPLI_sub001_count_alpha{1}(i,j) wPLI_sub001_count_alpha{2}(i,j)]);
    end
end

wPLI_sub001_memory_alpha = {mean(wPLI_epoch{8,3},3), mean(wPLI_epoch{10,3},3)};
wPLI_sub001_memory_alpha_avg = zeros(num_reg);
for i = 1:num_reg
    for j = 1:num_reg
        wPLI_sub001_memory_alpha_avg(i,j) = mean([wPLI_sub001_memory_alpha{1}(i,j) wPLI_sub001_memory_alpha{2}(i,j)]);
    end
end

wPLI_sub001_NS_alpha_avg = mean(wPLI_epoch{11,3},3);

min_val = min(min([wPLI_sub001_count_alpha_avg; wPLI_sub001_memory_alpha_avg; wPLI_sub001_NS_alpha_avg]));
max_val = max(max([wPLI_sub001_count_alpha_avg; wPLI_sub001_memory_alpha_avg; wPLI_sub001_NS_alpha_avg]));

figure; 
subplot(3,5,1)
imagesc(wPLI_sub001_count_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,6)
imagesc(wPLI_sub001_memory_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,11)
imagesc(wPLI_sub001_NS_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub003_count_alpha_avg = mean(wPLI_epoch{1,3},3);

wPLI_sub003_memory_alpha_avg = mean(wPLI_epoch{2,3},3);

wPLI_sub003_NS_alpha = {mean(wPLI_epoch{3,3},3), mean(wPLI_epoch{4,3},3), mean(wPLI_epoch{5,3},3), mean(wPLI_epoch{6,3},3)};
wPLI_sub003_NS_alpha_avg = zeros(num_reg);
for i = 1:num_reg
    for j = 1:num_reg
        wPLI_sub003_NS_alpha_avg(i,j) = mean([wPLI_sub003_NS_alpha{1}(i,j) wPLI_sub003_NS_alpha{2}(i,j) wPLI_sub003_NS_alpha{3}(i,j) wPLI_sub003_NS_alpha{4}(i,j)]);
    end
end

min_val = min(min([wPLI_sub003_count_alpha_avg; wPLI_sub003_memory_alpha_avg; wPLI_sub003_NS_alpha_avg]));
max_val = max(max([wPLI_sub003_count_alpha_avg; wPLI_sub003_memory_alpha_avg; wPLI_sub003_NS_alpha_avg]));

subplot(3,5,2)
imagesc(wPLI_sub003_count_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,7)
imagesc(wPLI_sub003_memory_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,12)
imagesc(wPLI_sub003_NS_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub010_count_alpha = {mean(wPLI_epoch{12,3},3), mean(wPLI_epoch{14,3},3)};
wPLI_sub010_count_alpha_avg = zeros(num_reg);
for i = 1:num_reg
    for j = 1:num_reg
        wPLI_sub010_count_alpha_avg(i,j) = mean([wPLI_sub010_count_alpha{1}(i,j) wPLI_sub010_count_alpha{2}(i,j)]);
    end
end

wPLI_sub010_memory_alpha = {mean(wPLI_epoch{13,3},3), mean(wPLI_epoch{15,3},3)};
wPLI_sub010_memory_alpha_avg = zeros(num_reg);
for i = 1:num_reg
    for j = 1:num_reg
        wPLI_sub010_memory_alpha_avg(i,j) = mean([wPLI_sub010_memory_alpha{1}(i,j) wPLI_sub010_memory_alpha{2}(i,j)]);
    end
end

wPLI_sub010_NS_alpha = {mean(wPLI_epoch{17,3},3), mean(wPLI_epoch{18,3},3), mean(wPLI_epoch{19,3},3)};
wPLI_sub010_NS_alpha_avg = zeros(num_reg);
for i = 1:num_reg
    for j = 1:num_reg
        wPLI_sub010_NS_alpha_avg(i,j) = mean([wPLI_sub010_NS_alpha{1}(i,j) wPLI_sub010_NS_alpha{2}(i,j) wPLI_sub010_NS_alpha{3}(i,j)]);
    end
end

min_val = min(min([wPLI_sub010_count_alpha_avg; wPLI_sub010_memory_alpha_avg; wPLI_sub010_NS_alpha_avg]));
max_val = max(max([wPLI_sub010_count_alpha_avg; wPLI_sub010_memory_alpha_avg; wPLI_sub010_NS_alpha_avg]));

subplot(3,5,3)
imagesc(wPLI_sub010_count_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,8)
imagesc(wPLI_sub010_memory_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,13)
imagesc(wPLI_sub010_NS_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub029_count_alpha = {mean(wPLI_epoch{20,3},3), mean(wPLI_epoch{22,3},3)};
wPLI_sub029_count_alpha_avg = zeros(size(wPLI_epoch{20,3},1));
for i = 1:size(wPLI_epoch{20,3},1)
    for j = 1:size(wPLI_epoch{20,3},1)
        wPLI_sub029_count_alpha_avg(i,j) = mean([wPLI_sub029_count_alpha{1}(i,j) wPLI_sub029_count_alpha{2}(i,j)]);
    end
end

wPLI_sub029_memory_alpha = {mean(wPLI_epoch{21,3},3), mean(wPLI_epoch{23,3},3)};
wPLI_sub029_memory_alpha_avg = zeros(size(wPLI_epoch{21,3},1));
for i = 1:size(wPLI_epoch{21,3},1)
    for j = 1:size(wPLI_epoch{21,3},1)
        wPLI_sub029_memory_alpha_avg(i,j) = mean([wPLI_sub029_memory_alpha{1}(i,j) wPLI_sub029_memory_alpha{2}(i,j)]);
    end
end

wPLI_sub029_NS_alpha = {mean(wPLI_epoch{24,3},3), mean(wPLI_epoch{25,3},3)};
wPLI_sub029_NS_alpha_avg = zeros(size(wPLI_epoch{24,3},1));
for i = 1:size(wPLI_epoch{24,3},1)
    for j = 1:size(wPLI_epoch{24,3},1)
        wPLI_sub029_NS_alpha_avg(i,j) = mean([wPLI_sub029_NS_alpha{1}(i,j) wPLI_sub029_NS_alpha{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub029_count_alpha_avg(:); wPLI_sub029_memory_alpha_avg(:); wPLI_sub029_NS_alpha_avg(:)]));
max_val = max(max([wPLI_sub029_count_alpha_avg(:); wPLI_sub029_memory_alpha_avg(:); wPLI_sub029_NS_alpha_avg(:)]));

subplot(3,5,4)
imagesc(wPLI_sub029_count_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,9)
imagesc(wPLI_sub029_memory_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,14)
imagesc(wPLI_sub029_NS_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub034_count_alpha = {mean(wPLI_epoch{30,3},3), mean(wPLI_epoch{31,3},3)};
wPLI_sub034_count_alpha_avg = zeros(size(wPLI_epoch{30,3},1));
for i = 1:size(wPLI_epoch{30,3},1)
    for j = 1:size(wPLI_epoch{30,3},1)
        wPLI_sub034_count_alpha_avg(i,j) = mean([wPLI_sub034_count_alpha{1}(i,j) wPLI_sub034_count_alpha{2}(i,j)]);
    end
end

wPLI_sub034_memory_alpha = {mean(wPLI_epoch{27,3},3), mean(wPLI_epoch{29,3},3)};
wPLI_sub034_memory_alpha_avg = zeros(size(wPLI_epoch{27,3},1));
for i = 1:size(wPLI_epoch{27,3},1)
    for j = 1:size(wPLI_epoch{27,3},1)
        wPLI_sub034_memory_alpha_avg(i,j) = mean([wPLI_sub034_memory_alpha{1}(i,j) wPLI_sub034_memory_alpha{2}(i,j)]);
    end
end

wPLI_sub034_NS_alpha = {mean(wPLI_epoch{26,3},3), mean(wPLI_epoch{28,3},3)};
wPLI_sub034_NS_alpha_avg = zeros(size(wPLI_epoch{26,3},1));
for i = 1:size(wPLI_epoch{26,3},1)
    for j = 1:size(wPLI_epoch{26,3},1)
        wPLI_sub034_NS_alpha_avg(i,j) = mean([wPLI_sub034_NS_alpha{1}(i,j) wPLI_sub034_NS_alpha{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub034_count_alpha_avg(:); wPLI_sub034_memory_alpha_avg(:); wPLI_sub034_NS_alpha_avg(:)]));
max_val = max(max([wPLI_sub034_count_alpha_avg(:); wPLI_sub034_memory_alpha_avg(:); wPLI_sub034_NS_alpha_avg(:)]));

subplot(3,5,5)
imagesc(wPLI_sub034_count_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,10)
imagesc(wPLI_sub034_memory_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,15)
imagesc(wPLI_sub034_NS_alpha_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub001_count_lowbeta = {mean(wPLI_epoch{7,4},3), mean(wPLI_epoch{9,4},3)};
wPLI_sub001_count_lowbeta_avg = zeros(size(wPLI_epoch{7,4},1));
for i = 1:size(wPLI_epoch{7,4},1)
    for j = 1:size(wPLI_epoch{7,4},1)
        wPLI_sub001_count_lowbeta_avg(i,j) = mean([wPLI_sub001_count_lowbeta{1}(i,j) wPLI_sub001_count_lowbeta{2}(i,j)]);
    end
end

wPLI_sub001_memory_lowbeta = {mean(wPLI_epoch{8,4},3), mean(wPLI_epoch{10,4},3)};
wPLI_sub001_memory_lowbeta_avg = zeros(size(wPLI_epoch{8,4},1));
for i = 1:size(wPLI_epoch{8,4},1)
    for j = 1:size(wPLI_epoch{8,4},1)
        wPLI_sub001_memory_lowbeta_avg(i,j) = mean([wPLI_sub001_memory_lowbeta{1}(i,j) wPLI_sub001_memory_lowbeta{2}(i,j)]);
    end
end

wPLI_sub001_NS_lowbeta_avg = mean(wPLI_epoch{11,4},3);

min_val = min(min([wPLI_sub001_count_lowbeta_avg(:); wPLI_sub001_memory_lowbeta_avg(:); wPLI_sub001_NS_lowbeta_avg(:)]));
max_val = max(max([wPLI_sub001_count_lowbeta_avg(:); wPLI_sub001_memory_lowbeta_avg(:); wPLI_sub001_NS_lowbeta_avg(:)]));

figure; 
subplot(3,5,1)
imagesc(wPLI_sub001_count_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,6)
imagesc(wPLI_sub001_memory_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,11)
imagesc(wPLI_sub001_NS_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub003_count_lowbeta_avg = mean(wPLI_epoch{1,4},3);

wPLI_sub003_memory_lowbeta_avg = mean(wPLI_epoch{2,4},3);

wPLI_sub003_NS_lowbeta = {mean(wPLI_epoch{3,4},3), mean(wPLI_epoch{4,4},3), mean(wPLI_epoch{5,4},3), mean(wPLI_epoch{6,4},3)};
wPLI_sub003_NS_lowbeta_avg = zeros(size(wPLI_epoch{3,4},1));
for i = 1:size(wPLI_epoch{3,4},1)
    for j = 1:size(wPLI_epoch{3,4},1)
        wPLI_sub003_NS_lowbeta_avg(i,j) = mean([wPLI_sub003_NS_lowbeta{1}(i,j) wPLI_sub003_NS_lowbeta{2}(i,j) wPLI_sub003_NS_lowbeta{3}(i,j) wPLI_sub003_NS_lowbeta{4}(i,j)]);
    end
end

min_val = min(min([wPLI_sub003_count_lowbeta_avg; wPLI_sub003_memory_lowbeta_avg; wPLI_sub003_NS_lowbeta_avg]));
max_val = max(max([wPLI_sub003_count_lowbeta_avg; wPLI_sub003_memory_lowbeta_avg; wPLI_sub003_NS_lowbeta_avg]));

subplot(3,5,2)
imagesc(wPLI_sub003_count_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,7)
imagesc(wPLI_sub003_memory_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,12)
imagesc(wPLI_sub003_NS_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub010_count_lowbeta = {mean(wPLI_epoch{12,4},3), mean(wPLI_epoch{14,4},3)};
wPLI_sub010_count_lowbeta_avg = zeros(size(wPLI_epoch{12,4},1));
for i = 1:size(wPLI_epoch{12,4},1)
    for j = 1:size(wPLI_epoch{12,4},1)
        wPLI_sub010_count_lowbeta_avg(i,j) = mean([wPLI_sub010_count_lowbeta{1}(i,j) wPLI_sub010_count_lowbeta{2}(i,j)]);
    end
end

wPLI_sub010_memory_lowbeta = {mean(wPLI_epoch{13,4},3), mean(wPLI_epoch{15,4},3)};
wPLI_sub010_memory_lowbeta_avg = zeros(size(wPLI_epoch{13,4},1));
for i = 1:size(wPLI_epoch{13,4},1)
    for j = 1:size(wPLI_epoch{13,4},1)
        wPLI_sub010_memory_lowbeta_avg(i,j) = mean([wPLI_sub010_memory_lowbeta{1}(i,j) wPLI_sub010_memory_lowbeta{2}(i,j)]);
    end
end

wPLI_sub010_NS_lowbeta = {mean(wPLI_epoch{17,4},3), mean(wPLI_epoch{18,4},3), mean(wPLI_epoch{19,4},3)};
wPLI_sub010_NS_lowbeta_avg = zeros(size(wPLI_epoch{17,4},1));
for i = 1:size(wPLI_epoch{17,4},1)
    for j = 1:size(wPLI_epoch{17,4},1)
        wPLI_sub010_NS_lowbeta_avg(i,j) = mean([wPLI_sub010_NS_lowbeta{1}(i,j) wPLI_sub010_NS_lowbeta{2}(i,j) wPLI_sub010_NS_lowbeta{3}(i,j)]);
    end
end

min_val = min(min([wPLI_sub010_count_lowbeta_avg(:); wPLI_sub010_memory_lowbeta_avg(:); wPLI_sub010_NS_lowbeta_avg(:)]));
max_val = max(max([wPLI_sub010_count_lowbeta_avg(:); wPLI_sub010_memory_lowbeta_avg(:); wPLI_sub010_NS_lowbeta_avg(:)]));

subplot(3,5,3)
imagesc(wPLI_sub010_count_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,8)
imagesc(wPLI_sub010_memory_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,13)
imagesc(wPLI_sub010_NS_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub029_count_lowbeta = {mean(wPLI_epoch{20,4},3), mean(wPLI_epoch{22,4},3)};
wPLI_sub029_count_lowbeta_avg = zeros(size(wPLI_epoch{20,4},1));
for i = 1:size(wPLI_epoch{20,4},1)
    for j = 1:size(wPLI_epoch{20,4},1)
        wPLI_sub029_count_lowbeta_avg(i,j) = mean([wPLI_sub029_count_lowbeta{1}(i,j) wPLI_sub029_count_lowbeta{2}(i,j)]);
    end
end

wPLI_sub029_memory_lowbeta = {mean(wPLI_epoch{21,4},3), mean(wPLI_epoch{23,4},3)};
wPLI_sub029_memory_lowbeta_avg = zeros(size(wPLI_epoch{21,4},1));
for i = 1:size(wPLI_epoch{21,4},1)
    for j = 1:size(wPLI_epoch{21,4},1)
        wPLI_sub029_memory_lowbeta_avg(i,j) = mean([wPLI_sub029_memory_lowbeta{1}(i,j) wPLI_sub029_memory_lowbeta{2}(i,j)]);
    end
end

wPLI_sub029_NS_lowbeta = {mean(wPLI_epoch{24,4},3), mean(wPLI_epoch{25,4},3)};
wPLI_sub029_NS_lowbeta_avg = zeros(size(wPLI_epoch{24,4},1));
for i = 1:size(wPLI_epoch{24,4},1)
    for j = 1:size(wPLI_epoch{24,4},1)
        wPLI_sub029_NS_lowbeta_avg(i,j) = mean([wPLI_sub029_NS_lowbeta{1}(i,j) wPLI_sub029_NS_lowbeta{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub029_count_lowbeta_avg(:); wPLI_sub029_memory_lowbeta_avg(:); wPLI_sub029_NS_lowbeta_avg(:)]));
max_val = max(max([wPLI_sub029_count_lowbeta_avg(:); wPLI_sub029_memory_lowbeta_avg(:); wPLI_sub029_NS_lowbeta_avg(:)]));

subplot(3,5,4)
imagesc(wPLI_sub029_count_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,9)
imagesc(wPLI_sub029_memory_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,14)
imagesc(wPLI_sub029_NS_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub034_count_lowbeta = {mean(wPLI_epoch{26,4},3), mean(wPLI_epoch{28,4},3)};
wPLI_sub034_count_lowbeta_avg = zeros(size(wPLI_epoch{7,4},1));
for i = 1:size(wPLI_epoch{26,4},1)
    for j = 1:size(wPLI_epoch{26,4},1)
        wPLI_sub034_count_lowbeta_avg(i,j) = mean([wPLI_sub034_count_lowbeta{1}(i,j) wPLI_sub034_count_lowbeta{2}(i,j)]);
    end
end

wPLI_sub034_memory_lowbeta = {mean(wPLI_epoch{27,4},3), mean(wPLI_epoch{29,4},3)};
wPLI_sub034_memory_lowbeta_avg = zeros(size(wPLI_epoch{8,4},1));
for i = 1:size(wPLI_epoch{27,4},1)
    for j = 1:size(wPLI_epoch{27,4},1)
        wPLI_sub034_memory_lowbeta_avg(i,j) = mean([wPLI_sub034_memory_lowbeta{1}(i,j) wPLI_sub034_memory_lowbeta{2}(i,j)]);
    end
end

wPLI_sub034_NS_lowbeta = {mean(wPLI_epoch{30,4},3), mean(wPLI_epoch{31,4},3)};
wPLI_sub034_NS_lowbeta_avg = zeros(size(wPLI_epoch{30,4},1));
for i = 1:size(wPLI_epoch{30,4},1)
    for j = 1:size(wPLI_epoch{30,4},1)
        wPLI_sub034_NS_lowbeta_avg(i,j) = mean([wPLI_sub034_NS_lowbeta{1}(i,j) wPLI_sub034_NS_lowbeta{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub034_count_lowbeta_avg(:); wPLI_sub034_memory_lowbeta_avg(:); wPLI_sub034_NS_lowbeta_avg(:)]));
max_val = max(max([wPLI_sub034_count_lowbeta_avg(:); wPLI_sub034_memory_lowbeta_avg(:); wPLI_sub034_NS_lowbeta_avg(:)]));

subplot(3,5,5)
imagesc(wPLI_sub034_count_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,10)
imagesc(wPLI_sub034_memory_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,15)
imagesc(wPLI_sub034_NS_lowbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub001_count_highbeta = {mean(wPLI_epoch{7,5},3), mean(wPLI_epoch{9,5},3)};
wPLI_sub001_count_highbeta_avg = zeros(size(wPLI_epoch{7,5},1));
for i = 1:size(wPLI_epoch{7,5},1)
    for j = 1:size(wPLI_epoch{7,5},1)
        wPLI_sub001_count_highbeta_avg(i,j) = mean([wPLI_sub001_count_highbeta{1}(i,j) wPLI_sub001_count_highbeta{2}(i,j)]);
    end
end

wPLI_sub001_memory_highbeta = {mean(wPLI_epoch{8,5},3), mean(wPLI_epoch{10,5},3)};
wPLI_sub001_memory_highbeta_avg = zeros(size(wPLI_epoch{8,5},1));
for i = 1:size(wPLI_epoch{8,5},1)
    for j = 1:size(wPLI_epoch{8,5},1)
        wPLI_sub001_memory_highbeta_avg(i,j) = mean([wPLI_sub001_memory_highbeta{1}(i,j) wPLI_sub001_memory_highbeta{2}(i,j)]);
    end
end

wPLI_sub001_NS_highbeta_avg = mean(wPLI_epoch{11,5},3);

min_val = min(min([wPLI_sub001_count_highbeta_avg(:); wPLI_sub001_memory_highbeta_avg(:); wPLI_sub001_NS_highbeta_avg(:)]));
max_val = max(max([wPLI_sub001_count_highbeta_avg(:); wPLI_sub001_memory_highbeta_avg(:); wPLI_sub001_NS_highbeta_avg(:)]));

figure; 
subplot(3,5,1)
imagesc(wPLI_sub001_count_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,6)
imagesc(wPLI_sub001_memory_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,11)
imagesc(wPLI_sub001_NS_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub003_count_highbeta_avg = mean(wPLI_epoch{1,5},3);

wPLI_sub003_memory_highbeta_avg = mean(wPLI_epoch{2,5},3);

wPLI_sub003_NS_highbeta = {mean(wPLI_epoch{3,5},3), mean(wPLI_epoch{4,5},3), mean(wPLI_epoch{5,5},3), mean(wPLI_epoch{6,5},3)};
wPLI_sub003_NS_highbeta_avg = zeros(size(wPLI_epoch{3,5},1));
for i = 1:size(wPLI_epoch{3,5},1)
    for j = 1:size(wPLI_epoch{3,5},1)
        wPLI_sub003_NS_highbeta_avg(i,j) = mean([wPLI_sub003_NS_highbeta{1}(i,j) wPLI_sub003_NS_highbeta{2}(i,j) wPLI_sub003_NS_highbeta{3}(i,j) wPLI_sub003_NS_highbeta{4}(i,j)]);
    end
end

min_val = min(min([wPLI_sub003_count_highbeta_avg; wPLI_sub003_memory_highbeta_avg; wPLI_sub003_NS_highbeta_avg]));
max_val = max(max([wPLI_sub003_count_highbeta_avg; wPLI_sub003_memory_highbeta_avg; wPLI_sub003_NS_highbeta_avg]));

subplot(3,5,2)
imagesc(wPLI_sub003_count_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,7)
imagesc(wPLI_sub003_memory_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,12)
imagesc(wPLI_sub003_NS_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub010_count_highbeta = {mean(wPLI_epoch{12,5},3), mean(wPLI_epoch{14,5},3)};
wPLI_sub010_count_highbeta_avg = zeros(size(wPLI_epoch{12,5},1));
for i = 1:size(wPLI_epoch{12,5},1)
    for j = 1:size(wPLI_epoch{12,5},1)
        wPLI_sub010_count_highbeta_avg(i,j) = mean([wPLI_sub010_count_highbeta{1}(i,j) wPLI_sub010_count_highbeta{2}(i,j)]);
    end
end

wPLI_sub010_memory_highbeta = {mean(wPLI_epoch{13,5},3), mean(wPLI_epoch{15,5},3)};
wPLI_sub010_memory_highbeta_avg = zeros(size(wPLI_epoch{13,5},1));
for i = 1:size(wPLI_epoch{13,5},1)
    for j = 1:size(wPLI_epoch{13,5},1)
        wPLI_sub010_memory_highbeta_avg(i,j) = mean([wPLI_sub010_memory_highbeta{1}(i,j) wPLI_sub010_memory_highbeta{2}(i,j)]);
    end
end

wPLI_sub010_NS_highbeta = {mean(wPLI_epoch{17,5},3), mean(wPLI_epoch{18,5},3), mean(wPLI_epoch{19,5},3)};
wPLI_sub010_NS_highbeta_avg = zeros(size(wPLI_epoch{17,5},1));
for i = 1:size(wPLI_epoch{17,5},1)
    for j = 1:size(wPLI_epoch{17,5},1)
        wPLI_sub010_NS_highbeta_avg(i,j) = mean([wPLI_sub010_NS_highbeta{1}(i,j) wPLI_sub010_NS_highbeta{2}(i,j) wPLI_sub010_NS_highbeta{3}(i,j)]);
    end
end

min_val = min(min([wPLI_sub010_count_highbeta_avg(:); wPLI_sub010_memory_highbeta_avg(:); wPLI_sub010_NS_highbeta_avg(:)]));
max_val = max(max([wPLI_sub010_count_highbeta_avg(:); wPLI_sub010_memory_highbeta_avg(:); wPLI_sub010_NS_highbeta_avg(:)]));

subplot(3,5,3)
imagesc(wPLI_sub010_count_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,8)
imagesc(wPLI_sub010_memory_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,13)
imagesc(wPLI_sub010_NS_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub029_count_highbeta = {mean(wPLI_epoch{20,5},3), mean(wPLI_epoch{22,5},3)};
wPLI_sub029_count_highbeta_avg = zeros(size(wPLI_epoch{20,5},1));
for i = 1:size(wPLI_epoch{20,5},1)
    for j = 1:size(wPLI_epoch{20,5},1)
        wPLI_sub029_count_highbeta_avg(i,j) = mean([wPLI_sub029_count_highbeta{1}(i,j) wPLI_sub029_count_highbeta{2}(i,j)]);
    end
end

wPLI_sub029_memory_highbeta = {mean(wPLI_epoch{21,5},3), mean(wPLI_epoch{23,5},3)};
wPLI_sub029_memory_highbeta_avg = zeros(size(wPLI_epoch{21,5},1));
for i = 1:size(wPLI_epoch{21,5},1)
    for j = 1:size(wPLI_epoch{21,5},1)
        wPLI_sub029_memory_highbeta_avg(i,j) = mean([wPLI_sub029_memory_highbeta{1}(i,j) wPLI_sub029_memory_highbeta{2}(i,j)]);
    end
end

wPLI_sub029_NS_highbeta = {mean(wPLI_epoch{24,5},3), mean(wPLI_epoch{25,5},3)};
wPLI_sub029_NS_highbeta_avg = zeros(size(wPLI_epoch{24,5},1));
for i = 1:size(wPLI_epoch{24,5},1)
    for j = 1:size(wPLI_epoch{24,5},1)
        wPLI_sub029_NS_highbeta_avg(i,j) = mean([wPLI_sub029_NS_highbeta{1}(i,j) wPLI_sub029_NS_highbeta{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub029_count_highbeta_avg(:); wPLI_sub029_memory_highbeta_avg(:); wPLI_sub029_NS_highbeta_avg(:)]));
max_val = max(max([wPLI_sub029_count_highbeta_avg(:); wPLI_sub029_memory_highbeta_avg(:); wPLI_sub029_NS_highbeta_avg(:)]));

subplot(3,5,4)
imagesc(wPLI_sub029_count_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,9)
imagesc(wPLI_sub029_memory_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,14)
imagesc(wPLI_sub029_NS_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub034_count_highbeta = {mean(wPLI_epoch{26,5},3), mean(wPLI_epoch{28,5},3)};
wPLI_sub034_count_highbeta_avg = zeros(size(wPLI_epoch{7,5},1));
for i = 1:size(wPLI_epoch{26,5},1)
    for j = 1:size(wPLI_epoch{26,5},1)
        wPLI_sub034_count_highbeta_avg(i,j) = mean([wPLI_sub034_count_highbeta{1}(i,j) wPLI_sub034_count_highbeta{2}(i,j)]);
    end
end

wPLI_sub034_memory_highbeta = {mean(wPLI_epoch{27,5},3), mean(wPLI_epoch{29,5},3)};
wPLI_sub034_memory_highbeta_avg = zeros(size(wPLI_epoch{8,5},1));
for i = 1:size(wPLI_epoch{27,5},1)
    for j = 1:size(wPLI_epoch{27,5},1)
        wPLI_sub034_memory_highbeta_avg(i,j) = mean([wPLI_sub034_memory_highbeta{1}(i,j) wPLI_sub034_memory_highbeta{2}(i,j)]);
    end
end

wPLI_sub034_NS_highbeta = {mean(wPLI_epoch{30,5},3), mean(wPLI_epoch{31,5},3)};
wPLI_sub034_NS_highbeta_avg = zeros(size(wPLI_epoch{30,5},1));
for i = 1:size(wPLI_epoch{30,5},1)
    for j = 1:size(wPLI_epoch{30,5},1)
        wPLI_sub034_NS_highbeta_avg(i,j) = mean([wPLI_sub034_NS_highbeta{1}(i,j) wPLI_sub034_NS_highbeta{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub034_count_highbeta_avg(:); wPLI_sub034_memory_highbeta_avg(:); wPLI_sub034_NS_highbeta_avg(:)]));
max_val = max(max([wPLI_sub034_count_highbeta_avg(:); wPLI_sub034_memory_highbeta_avg(:); wPLI_sub034_NS_highbeta_avg(:)]));

subplot(3,5,5)
imagesc(wPLI_sub034_count_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,10)
imagesc(wPLI_sub034_memory_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,15)
imagesc(wPLI_sub034_NS_highbeta_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub001_count_gamma = {mean(wPLI_epoch{7,6},3), mean(wPLI_epoch{9,6},3)};
wPLI_sub001_count_gamma_avg = zeros(size(wPLI_epoch{7,6},1));
for i = 1:size(wPLI_epoch{7,6},1)
    for j = 1:size(wPLI_epoch{7,6},1)
        wPLI_sub001_count_gamma_avg(i,j) = mean([wPLI_sub001_count_gamma{1}(i,j) wPLI_sub001_count_gamma{2}(i,j)]);
    end
end

wPLI_sub001_memory_gamma = {mean(wPLI_epoch{8,6},3), mean(wPLI_epoch{10,6},3)};
wPLI_sub001_memory_gamma_avg = zeros(size(wPLI_epoch{8,6},1));
for i = 1:size(wPLI_epoch{8,6},1)
    for j = 1:size(wPLI_epoch{8,6},1)
        wPLI_sub001_memory_gamma_avg(i,j) = mean([wPLI_sub001_memory_gamma{1}(i,j) wPLI_sub001_memory_gamma{2}(i,j)]);
    end
end

wPLI_sub001_NS_gamma_avg = mean(wPLI_epoch{11,6},3);

min_val = min(min([wPLI_sub001_count_gamma_avg(:); wPLI_sub001_memory_gamma_avg(:); wPLI_sub001_NS_gamma_avg(:)]));
max_val = max(max([wPLI_sub001_count_gamma_avg(:); wPLI_sub001_memory_gamma_avg(:); wPLI_sub001_NS_gamma_avg(:)]));

figure; 
subplot(3,5,1)
imagesc(wPLI_sub001_count_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,6)
imagesc(wPLI_sub001_memory_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,11)
imagesc(wPLI_sub001_NS_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub003_count_gamma_avg = mean(wPLI_epoch{1,6},3);

wPLI_sub003_memory_gamma_avg = mean(wPLI_epoch{2,6},3);

wPLI_sub003_NS_gamma = {mean(wPLI_epoch{3,6},3), mean(wPLI_epoch{4,6},3), mean(wPLI_epoch{5,6},3), mean(wPLI_epoch{6,6},3)};
wPLI_sub003_NS_gamma_avg = zeros(size(wPLI_epoch{3,6},1));
for i = 1:size(wPLI_epoch{3,6},1)
    for j = 1:size(wPLI_epoch{3,6},1)
        wPLI_sub003_NS_gamma_avg(i,j) = mean([wPLI_sub003_NS_gamma{1}(i,j) wPLI_sub003_NS_gamma{2}(i,j) wPLI_sub003_NS_gamma{3}(i,j) wPLI_sub003_NS_gamma{4}(i,j)]);
    end
end

min_val = min(min([wPLI_sub003_count_gamma_avg; wPLI_sub003_memory_gamma_avg; wPLI_sub003_NS_gamma_avg]));
max_val = max(max([wPLI_sub003_count_gamma_avg; wPLI_sub003_memory_gamma_avg; wPLI_sub003_NS_gamma_avg]));

subplot(3,5,2)
imagesc(wPLI_sub003_count_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,7)
imagesc(wPLI_sub003_memory_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,12)
imagesc(wPLI_sub003_NS_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub010_count_gamma = {mean(wPLI_epoch{12,6},3), mean(wPLI_epoch{14,6},3)};
wPLI_sub010_count_gamma_avg = zeros(size(wPLI_epoch{12,6},1));
for i = 1:size(wPLI_epoch{12,6},1)
    for j = 1:size(wPLI_epoch{12,6},1)
        wPLI_sub010_count_gamma_avg(i,j) = mean([wPLI_sub010_count_gamma{1}(i,j) wPLI_sub010_count_gamma{2}(i,j)]);
    end
end

wPLI_sub010_memory_gamma = {mean(wPLI_epoch{13,6},3), mean(wPLI_epoch{15,6},3)};
wPLI_sub010_memory_gamma_avg = zeros(size(wPLI_epoch{13,6},1));
for i = 1:size(wPLI_epoch{13,6},1)
    for j = 1:size(wPLI_epoch{13,6},1)
        wPLI_sub010_memory_gamma_avg(i,j) = mean([wPLI_sub010_memory_gamma{1}(i,j) wPLI_sub010_memory_gamma{2}(i,j)]);
    end
end

wPLI_sub010_NS_gamma = {mean(wPLI_epoch{17,6},3), mean(wPLI_epoch{18,6},3), mean(wPLI_epoch{19,6},3)};
wPLI_sub010_NS_gamma_avg = zeros(size(wPLI_epoch{17,6},1));
for i = 1:size(wPLI_epoch{17,6},1)
    for j = 1:size(wPLI_epoch{17,6},1)
        wPLI_sub010_NS_gamma_avg(i,j) = mean([wPLI_sub010_NS_gamma{1}(i,j) wPLI_sub010_NS_gamma{2}(i,j) wPLI_sub010_NS_gamma{3}(i,j)]);
    end
end

min_val = min(min([wPLI_sub010_count_gamma_avg(:); wPLI_sub010_memory_gamma_avg(:); wPLI_sub010_NS_gamma_avg(:)]));
max_val = max(max([wPLI_sub010_count_gamma_avg(:); wPLI_sub010_memory_gamma_avg(:); wPLI_sub010_NS_gamma_avg(:)]));

subplot(3,5,3)
imagesc(wPLI_sub010_count_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,8)
imagesc(wPLI_sub010_memory_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,13)
imagesc(wPLI_sub010_NS_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub029_count_gamma = {mean(wPLI_epoch{20,6},3), mean(wPLI_epoch{22,6},3)};
wPLI_sub029_count_gamma_avg = zeros(size(wPLI_epoch{20,6},1));
for i = 1:size(wPLI_epoch{20,6},1)
    for j = 1:size(wPLI_epoch{20,6},1)
        wPLI_sub029_count_gamma_avg(i,j) = mean([wPLI_sub029_count_gamma{1}(i,j) wPLI_sub029_count_gamma{2}(i,j)]);
    end
end

wPLI_sub029_memory_gamma = {mean(wPLI_epoch{21,6},3), mean(wPLI_epoch{23,6},3)};
wPLI_sub029_memory_gamma_avg = zeros(size(wPLI_epoch{21,6},1));
for i = 1:size(wPLI_epoch{21,6},1)
    for j = 1:size(wPLI_epoch{21,6},1)
        wPLI_sub029_memory_gamma_avg(i,j) = mean([wPLI_sub029_memory_gamma{1}(i,j) wPLI_sub029_memory_gamma{2}(i,j)]);
    end
end

wPLI_sub029_NS_gamma = {mean(wPLI_epoch{24,6},3), mean(wPLI_epoch{25,6},3)};
wPLI_sub029_NS_gamma_avg = zeros(size(wPLI_epoch{24,6},1));
for i = 1:size(wPLI_epoch{24,6},1)
    for j = 1:size(wPLI_epoch{24,6},1)
        wPLI_sub029_NS_gamma_avg(i,j) = mean([wPLI_sub029_NS_gamma{1}(i,j) wPLI_sub029_NS_gamma{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub029_count_gamma_avg(:); wPLI_sub029_memory_gamma_avg(:); wPLI_sub029_NS_gamma_avg(:)]));
max_val = max(max([wPLI_sub029_count_gamma_avg(:); wPLI_sub029_memory_gamma_avg(:); wPLI_sub029_NS_gamma_avg(:)]));

subplot(3,5,4)
imagesc(wPLI_sub029_count_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,9)
imagesc(wPLI_sub029_memory_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,14)
imagesc(wPLI_sub029_NS_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
wPLI_sub034_count_gamma = {mean(wPLI_epoch{26,6},3), mean(wPLI_epoch{28,6},3)};
wPLI_sub034_count_gamma_avg = zeros(size(wPLI_epoch{7,6},1));
for i = 1:size(wPLI_epoch{26,6},1)
    for j = 1:size(wPLI_epoch{26,6},1)
        wPLI_sub034_count_gamma_avg(i,j) = mean([wPLI_sub034_count_gamma{1}(i,j) wPLI_sub034_count_gamma{2}(i,j)]);
    end
end

wPLI_sub034_memory_gamma = {mean(wPLI_epoch{27,6},3), mean(wPLI_epoch{29,6},3)};
wPLI_sub034_memory_gamma_avg = zeros(size(wPLI_epoch{8,6},1));
for i = 1:size(wPLI_epoch{27,6},1)
    for j = 1:size(wPLI_epoch{27,6},1)
        wPLI_sub034_memory_gamma_avg(i,j) = mean([wPLI_sub034_memory_gamma{1}(i,j) wPLI_sub034_memory_gamma{2}(i,j)]);
    end
end

wPLI_sub034_NS_gamma = {mean(wPLI_epoch{30,6},3), mean(wPLI_epoch{31,6},3)};
wPLI_sub034_NS_gamma_avg = zeros(size(wPLI_epoch{30,6},1));
for i = 1:size(wPLI_epoch{30,6},1)
    for j = 1:size(wPLI_epoch{30,6},1)
        wPLI_sub034_NS_gamma_avg(i,j) = mean([wPLI_sub034_NS_gamma{1}(i,j) wPLI_sub034_NS_gamma{2}(i,j)]);
    end
end

min_val = min(min([wPLI_sub034_count_gamma_avg(:); wPLI_sub034_memory_gamma_avg(:); wPLI_sub034_NS_gamma_avg(:)]));
max_val = max(max([wPLI_sub034_count_gamma_avg(:); wPLI_sub034_memory_gamma_avg(:); wPLI_sub034_NS_gamma_avg(:)]));

subplot(3,5,5)
imagesc(wPLI_sub034_count_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,10)
imagesc(wPLI_sub034_memory_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
subplot(3,5,15)
imagesc(wPLI_sub034_NS_gamma_avg(new_order,new_order)); colorbar; clim([min_val max_val])
hold on;
...
% Let's say you know which data vector belongs to which subject/condition
% Create an index map of size 19 x 2: column 1 = subject (1–3), column 2 = condition (1–3)
